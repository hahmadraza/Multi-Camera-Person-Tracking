...
setup(
    ...
    url='https://github.com/hahmadraza/Multi-Camera-Person-Tracking',
    project_urls={
        'Bug Reports': 'https://github.com/hahmadraza/Multi-Camera-Person-Tracking/issues',
        'Source': 'https://github.com/hahmadraza/Multi-Camera-Person-Tracking'},
    author='Mikel Brostrom',
    author_email='h.ahmadraz@gmail.com',
